...
// Rota raiz (opcional) — evita "Cannot GET /"
app.get('/', (req, res) => {
  res.send('Backend rodando! Use /api/register, /api/login ou /api/profile');
});
...
app.post('/api/register', async (req, res) => {
  try {
    ...
    await run('INSERT INTO usuarios (nome, email, senha) VALUES (?, ?, ?)', [nome, email, hash]);
...
// Start server
app.listen(PORT, () => console.log(`Backend (SQLite) rodando na porta ${PORT}`));
